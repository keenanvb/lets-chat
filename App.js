...
const App = () => {
	...
	const createHomeStack = () => (
		<Stack.Navigator>
			...
			<Drawer.Screen name="Swipe" component={Swipe} />

			{/* <Stack.Screen name="Bottom Tabs" children={createBottomTabs} /> */}
			{/* <Stack.Screen name="Top Tabs" children={createBottomTabs} /> */}
			{/* <Stack.Screen name="Top Tabs" options={{ headerShown: false }} children={createTopTabs} /> */}
			<Stack.Screen
				name="Top Tabs"
	...
	const createDrawer = () => (
		<Drawer.Navigator initialRouteName="Top Tabs Draw">
			<Drawer.Screen name="Top Tabs Draw" options={{ title: 'Lets Chat' }} component={createTopTabs} />
			<Drawer.Screen name="Settings" component={Screen1} />
			<Drawer.Screen name="Account" component={Screen2} />
			<Drawer.Screen name="Logout" component={Screen3} />
		</Drawer.Navigator>
	);
	...
	const createTopTabs = (props) => {
		return (
			<MaterialTopTabs.Navigator>
				<MaterialTopTabs.Screen name="Tab 1" component={Tab1} options={{ title: 'Profile' }} />
				<MaterialTopTabs.Screen name="Tab 2" component={Tab2} options={{ title: 'Swipe' }} />
				<MaterialTopTabs.Screen name="Tab 3" component={createChatStack} options={{ title: 'Chat' }} />
			</MaterialTopTabs.Navigator>
		);
	};
	...
	const createChatStack = (props) => {
		return (
			<Stack.Navigator>
				<Stack.Screen name="Connections" component={Tab3} options={{ headerShown: false }} />
				<Stack.Screen
					name="Chat"
					component={Chat}
