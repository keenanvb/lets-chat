...
import { AppRegistry, Animated, Easing, StyleSheet, Text, View, TextInput, TouchableOpacity } from 'react-native';
...
const Notification = ({ alerts }) => {
	...
	return (
		<>
			<Animated.View style={[styles.notification, notificationStyle]} ref={_notification}>
